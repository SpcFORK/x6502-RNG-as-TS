...
"use strict";var F=Object.defineProperty;var s=Object.getOwnPropertyDescriptor;var p=Object.getOwnPropertyNames;var y=Object.prototype.hasOwnProperty;var b=(o,t)=>{for(var e in t)F(o,e,{get:t[e],enumerable:!0})},w=(o,t,e,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of p(t))!y.call(o,n)&&n!==e&&F(o,n,{get:()=>t[n],enumerable:!(r=s(t,n))||r.enumerable});return o};var h=o=>w(F({},"__esModule",{value:!0}),o);var A={};b(A,{default:()=>v});module.exports=h(A);function f(o,t=[]){if(!o)throw new Error("No object provided to eobj.");o?.name&&t.push(o.name),t.push("default");let e={};for(let r of t){e[r]=o;try{window[r]=o}catch{}}try{globalThis.eval("module").exports=e}catch{}return e}var c=f(f,["eobj"]).default;function*k(o,t=-1){let e,r,n=o&255;function a(){e=n>>1&255,r=e}function l(){e>>>=3,n=n&-65281|e&255,e>>>=1,e^=n>>1&255,e>>>=1,e^=n>>1&255,e^=n&&255,n=n&-65281|e&255}function x(){e=r,n=n&-256|e&255,e<<=1,e^=n&255,e<<=3,e^=n&255,n=n&-256|e&255}function d(){return a(),l(),x(),n}let i,m=t,u;e:for(;m--;)for(;u=yield i=d();)if(typeof u=="boolean"){if(u)break e;typeof u=="number"&&(n=u)}return{error:void 0,type:"success",LAST_VAL:i}}var v=c(k,["quickB8RNG255"]).default;
//# sourceMappingURL=crng.js.map